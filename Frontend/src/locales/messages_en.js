export default {
	message: {
	  ...
	  poista_superadmin: "Remove superadmin rights",
	  ...
	  virheelliset_rivit: "Invalid rows",
	  ...
	  ei_uusia_laitteita_duplikaatteja_kuvaus: "All rows in the file are either duplicates or invalid. Select duplicates to import or correct the invalid rows and try again.",
	  ...
	  haluatko_tehda_superadminin: "Are you sure you want to give this user superadmin rights?",
	  haluatko_poistaa_kayttajan: "Are you sure you want to delete this user?",
	  kayttaja_poistettu: "User removed",
	  ...
	  palvelimen_tila_taynna: "Server storage is nearly full. Please contact IT support before uploading files.",
