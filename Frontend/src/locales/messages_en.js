export default {
	message: {
	  ...
	  tuo_tiedot_kuvaus: "You can import instruments into the system from an Excel file. Use the template to ensure the data is in the correct format.",
      tuo_tiedot_kuvaus_lisa: "Pay close attention to the header names, which should match exactly.",
	  vie_tiedot_kuvaus: "Download instrument records in Excel format.",
	  lataa_mallipohja: "Download template (.csv)",
	  valitse_tiedosto: "Select file",
	  tuo_tiedot_nappi: "Import data",
	  vie_instrumenttirekisteri: "Export instrument records (.csv)",
	  tiedot_tuotu_onnistuneesti: "Data imported successfully: {count} instruments added!",
