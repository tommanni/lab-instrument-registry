export default {
	message: {
	  ...
	  poista_superadmin: "Poista superadmin oikeudet",
	  ...
	  virheelliset_rivit: "Virheelliset rivit",
	  ...
	  ei_uusia_laitteita_duplikaatteja_kuvaus: "Kaikki tiedoston rivit ovat joko duplikaatteja tai virheellisiä. Valitse tuotavat duplikaatit tai korjaa virheelliset rivit ja yritä uudelleen.",
	  ...
	  peru_paivitys: "Peru",
	  paivita_yksi: "Päivitä vain tämä",
	  ...
	  liitteet: "Liitteet",
	  lisaa_liite: "Lisää liite",
	  max_tiedostokoko: "Maksimikoko",
	  kuvaus: "Kuvaus (pakollinen)",
      kuvaus_vaaditaan: "Kuvaus vaaditaan",
	  lataa_tiedosto: "Lataa tiedosto",
	  ladataan: "Ladataan",
	  lataa: "Lataa",
	  ...
	  palvelimen_tila_taynna: "Palvelimen tallennustila on lähes täynnä. Ota yhteyttä IT-tukeen ennen tiedostojen lataamista.",
	  ...
	  ei_liitteita: "Ei liitteitä",
	  liitteet_vain_kirjautuneille: "Liitteet näkyvät vain kirjautuneille käyttäjille",
	  odottaa_paivitysta: "Odottaa päivitystä",
